...
def inputChoice(options, message, error):
  answer = ""
  response_list = ""
...
if isAuthenticated(pin)==True: # In tis line of code you are callthe function isAuthenticate(pin)
    ...
    #The code below should execute if the user enters the correct PIN number.
    """The lines of code that are placed in this while will continue
    executing until the user enters 4, wich will "return the card" and
    ...
    while (option != "4"):
        ...
        option = input("Please enter option.") #You can delete this line once you add the correct code
